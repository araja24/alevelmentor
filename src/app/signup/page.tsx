  ...
  if (success) {
    return (
      <div className="relative flex min-h-screen items-center justify-center">
        <AnimatedBackground />
        <div className="relative z-10 w-full max-w-md mx-4 rounded-2xl border border-border bg-card/80 backdrop-blur-xl p-8 shadow-xl text-center">
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="rounded-2xl border border-border bg-card/80 backdrop-blur-xl p-8 shadow-xl">
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link href="/login" className="font-medium text-[#5a35f8] hover:text-[#4f2dd6]">
              Sign in
            </Link>
          </p>
        </div>
