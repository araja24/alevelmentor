...
export function ScrollWalkthrough() {
  ...
  const predictedGrade = useCountUp(2, statsActive); // e.g. 2-grade lift

  const linePath =
    "M4 64 Q 40 54 72 52 Q 104 48 136 40 Q 168 32 200 30 Q 232 28 264 22 Q 296 16 328 10";

  const dashboardMotionProps = prefersReduced
    ? {}
    : {
        style: {
          y: dashboardY,
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-[1.4fr,1fr] gap-8 items-stretch">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="rounded-xl border border-border bg-muted/30 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="inline-flex items-baseline gap-1 rounded-full bg-emerald-500/10 border border-emerald-500/25 px-3 py-1">
              ...
              {/* Bars that grow up from the bottom */}
              <div className="grid grid-cols-3 gap-3">
                {[72, 84, 93].map((value, index) => {
                  const baseDelay = index * 0.12;
                  const barScale = prefersReduced
                    ? 1
                    : useTransform(
                        scrollYProgress,
          ...
          {/* Story column: features highlighted in sequence */}
          <div className="space-y-4">
              ...
              <motion.div
                ...
                style={
                  prefersReduced
                    ...
                    : {
                        opacity: featureOne,
                        y: useTransform(featureOne, [0, 1], [12, 0]),
                      }
                }
              >
                <div className="mt-1 h-7 w-7 rounded-lg bg-[#5a35f8]/15 flex items-center justify-center text-[11px] font-semibold text-[#5a35f8]">
                  1
                </div>
                <div>
              ...
              <motion.div
                ...
                style={
                  prefersReduced
                    ...
                    : {
                        opacity: featureTwo,
                        y: useTransform(featureTwo, [0, 1], [12, 0]),
                      }
                }
              >
                <div className="mt-1 h-7 w-7 rounded-lg bg-[#5a35f8]/15 flex items-center justify-center text-[11px] font-semibold text-[#5a35f8]">
              ...
              <motion.div
                ...
                style={
                  prefersReduced
                    ? undefined
                    : {
                        opacity: featureThree,
                        y: useTransform(featureThree, [0, 1], [12, 0]),
                      }
                }
              >
                <div className="mt-1 h-7 w-7 rounded-lg bg-[#5a35f8]/15 flex items-center justify-center text-[11px] font-semibold text-[#5a35f8]">
            ...
            <div className="mt-3 grid grid-cols-3 gap-3">
              <div className="rounded-xl border border-border bg-card/80 px-3 py-3">
                ...
                <p className="text-xl font-semibold">{studyHours}</p>
                <p className="text-[11px] text-muted-foreground mt-0.5">
                  across all subjects
                </p>
              </div>
              <div className="rounded-xl border border-border bg-card/80 px-3 py-3">
                ...
                <p className="text-xl font-semibold">{weakAreasFixed}</p>
                <p className="text-[11px] text-muted-foreground mt-0.5">
                  targeted directly
                </p>
              </div>
